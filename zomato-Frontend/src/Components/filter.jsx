...
export default function Filter() {
  const commonButtonStyles = {
    bgColor: "white",
    color: "#9C9C9C", // Setting the color to the same as the SVG
    fontWeight: "normal", // Setting the font weight to the same as the SVG
    border: "1px solid #9C9C9C", // Adding a border with the same color as the SVG
    borderRadius: "4px", // Adding border radius to make the border rounded
    _hover: {
      bgColor: "#f8f8f8", // Add a hover background color if needed
    },
  };

  return (
    <Box w={"80%"} m={"auto"}>
      <Button {...commonButtonStyles} mr={"1%"} leftIcon={(
      ...
      <Button mr={"1%"} {...commonButtonStyles}>Rating: 4.0+</Button>
      <Button mr={"1%"} {...commonButtonStyles}>Cuisines</Button>
    </Box>
  )
}
